    ...
    <body class="login-page">
        ...
        <section class="contact-page-section">
            <div class="container text-center">
                <h1 class="login-title"><?php echo getLang('login_title') ?></h1>
                <h2 class="login-subtitle mb-4"><?php echo getLang('login_subtitle') ?></h2>
                <p id="i2lay"><b id="i1we9"><?php echo getLang('login_instructions_text') ?></b></p>
                <p id="irwpy"><?php echo getLang('login_note_text') ?></p>
            </div>
            <div class="container" id="iynss">
                <div id="form-main" class="form-wrapper mt-4 mt-md-5">
                    <div class="form-header">
                        <h3 class="form-title"><?php echo getLang('login_form_title') ?></h3>
                        <div class="form-subtitle"><?php echo getLang('login_form_subtitle') ?></div>
                    </div>
                    <?php
